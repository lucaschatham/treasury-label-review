...
- Decorative text, competing headings, unusual layouts, low resolution, glare, blur, inverted (light-on-dark) statements and curved bottles can defeat OCR or the weight measurement. Missing evidence never becomes an all-clear. Low OCR confidence adds an attention item even when individual text matches exist.
